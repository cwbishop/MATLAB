function [v5, CF] = wav2aud(x, paras, filt, VERB)
...
% Estimate characteric frequencies.
%   This is largely assumed based on the help file. The denominator is
%   supposed to scale the CF by the octave shift. 
